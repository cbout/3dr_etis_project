...
\paragraph{MISSION COUNT} First of all, you have to send a MAVLINK\_MSG\_ID\_MISSION\_COUNT. This message contains : the count which represent the number of mission items in the sequence, the target\_system ID and the target\_component ID.
...
\paragraph{MISSION ITEM}  Next, you send some MAVLINK\_MSG\_ID\_MISSION\_ITEM...
